...
namespace Reliance.Web.Services.Infrastructure
{
    public class ThisAppSettings
    {
        ...
        public static bool EmailEnableSsl => bool.TryParse(Configuration["AppSettings:EmailEnableSsl"], out bool v) && v;
...
#endif
                    if (SnowStorm.RunningAs.UnitTest) //todo: find better fix using injection?
                        fileName = "appsettings.Development.json";
